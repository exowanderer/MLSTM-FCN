...
arabic_digits_dataset = r""

''' Load train set '''
data_dict = loadmat(arabic_digits_dataset + "Adigits.mat")
...
np.save(arabic_digits_dataset + 'X_train.npy', X_train)
np.save(arabic_digits_dataset + 'y_train.npy', y_train)
np.save(arabic_digits_dataset + 'X_test.npy', X_test)
np.save(arabic_digits_dataset + 'y_test.npy', y_test)
